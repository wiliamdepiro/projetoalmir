...
public partial class CadastrarEmpresa : System.Web.UI.Page
{
    ...
    protected void DetailsView1_ItemInserted2(object sender, DetailsViewInsertedEventArgs e)
    {
        GridView1.DataBind();
        GridView1.SelectRow(-1);
    }

    protected void DetailsView1_ItemUpdated2(object sender, DetailsViewUpdatedEventArgs e)
    {
        GridView1.DataBind();
        GridView1.SelectRow(-1);
    }
